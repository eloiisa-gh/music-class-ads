...
print("google_genai_use_vertexai:", google_genai_use_vertexai)

IMAGE_MODEL = os.getenv("IMAGE_MODEL")
print("IMAGE_MODEL:", IMAGE_MODEL, "\n")


# Provide the required arguments either directly or by using environment variables
client = genai.Client()
...
print(f"\n🎼 🎶 🎵 Music class ad generation - Illustration agent")
